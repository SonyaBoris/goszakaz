    ...
    <main>
      <AnimatedSwitch>
        <div className="contact">
          ...
          Voluptas, consequatur commodi voluptate ducimus praesentium suscipit ullam nisi deserunt exercitationem doloremque culpa maxime recusandae beatae. Sapiente in natus animi atque amet voluptate, libero dolorem nobis possimus eius sed reprehenderit!
          Unde error necessitatibus quos. Natus fugit nostrum deleniti commodi autem nulla dolores omnis architecto consequuntur excepturi ducimus, doloribus cumque id similique ipsam asperiores error perferendis molestiae. Harum voluptatum eos fuga!
